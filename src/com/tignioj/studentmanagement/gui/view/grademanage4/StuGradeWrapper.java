...
public class StuGradeWrapper extends RecursiveTreeObject<StuGradeWrapper>  {
    ...
    public boolean equals(Object o) {
        ...
        StuGradeWrapper that = (StuGradeWrapper) o;
    ...
    public StuGradeWrapper() {
    }

    public StuGradeWrapper(StuGrade stuGrade) {
...
//                        GradeManageController controller = (GradeManageController) Router.getController(Router.gradeTableBindingView4);
//                        controller.refreshDate(GradeManageController.RefreshType.GRADE_DEL, sw);
    ...
    //修改后的值
    public void updateOne(StuGradeWrapper sw) {
