...
public class StuGradeRescurive extends RecursiveTreeObject<StuGradeRescurive> {
    private int id;
    ...
    public StuGradeRescurive() {
    }

    public StuGradeRescurive(int id, StuInfo stuInfo, String stuYear, double stuGrade, int stuTerm) {
        this.id = id;
        this.stuInfo = stuInfo;
        this.stuYear = stuYear;
        this.stuGrade = stuGrade;
